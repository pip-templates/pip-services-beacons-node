...
import { BeaconsJsonSqlServerPersistence } from '../../src/persistence/BeaconsJsonSqlServerPersistence';
import { BeaconsPersistenceFixture } from './BeaconsPersistenceFixture';

suite('BeaconsJsonSqlServerPersistence', () => {
    let persistence: BeaconsJsonSqlServerPersistence;
    ...
    setup((done) => {
        persistence = new BeaconsJsonSqlServerPersistence();
